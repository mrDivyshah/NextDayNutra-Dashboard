                              ...
                              <td colSpan={3} style={{ padding: "8px 24px 20px 48px" }}>
                                <div style={{ display: "flex", background: "#8fa3c0", borderRadius: 12, padding: "16px 0", marginBottom: 12, alignItems: "center", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.1)" }}>
                                  {[
                                    ...
                                    <div key={stat.label} style={{ flex: 1, textAlign: "center", borderRight: stat.border ? "1px solid rgba(255,255,255,0.3)" : undefined }}>
                                      <div style={{ fontSize: 10, fontWeight: 700, color: "#fff", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 4 }}>{stat.label}</div>
